...
public class GetWorkplaceResources {
    ...
    public Map getTheme(int orgNum) throws IOException {
        CloseableHttpClient client = HttpClients.createDefault();
        ...
        Map themeMap = objectMapper.readValue(themeMapString, Map.class);
        client.close();
        return themeMap;
    }

    //Creates authorizaion header for resource server authorization
    private String makeAuthorization(String resource_server_username, String resource_server_password) {
