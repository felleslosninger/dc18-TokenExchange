...
public class HomeController implements WebMvcConfigurer {
    private final GetWorkplaceResources getWorkplaceResources;

    @Autowired
    public HomeController(GetWorkplaceResources getWorkplaceResources) {
        this.getWorkplaceResources = getWorkplaceResources;
    }
    ...
    public String getWorkplace(final Model model) throws IOException {
        ...
        Map theme = getWorkplaceResources.getTheme(tempOrgNum);
        Object pri_col = theme.get("pri_col");
        Object sec_col = theme.get("sec_col");
