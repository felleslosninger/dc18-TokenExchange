...
import com.dc18TokenExchange.STSserver.jwt.exceptions.*;
import com.dc18TokenExchange.STSserver.jwt.impl.PublicClaims;
...
import com.dc18TokenExchange.STSserver.jwt.interfaces.Verification;
...
public final class JWTVerifier {
    ...
    private void verifyAlgorithm(DecodedJWT jwt, Algorithm expectedAlgorithm) throws AlgorithmMismatchException {
        if (!expectedAlgorithm.getName().equals(jwt.getAlgorithm())) {
            throw new AlgorithmMismatchException("The provided Algorithm doesn't match the one defined in the Header of JWT.");
        }
    }
