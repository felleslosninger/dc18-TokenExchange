...
import com.dc18TokenExchange.STSserver.jwt.UserPojo;
...
import static com.dc18TokenExchange.STSserver.jwt.impl.JsonNodeClaim.claimFromNode;
...
public class JsonNodeClaimTest {
    ...
    public void shouldGetAsMapValue() {
        ...
        assertThat(((Map<String, Object>) map.get("key")), hasEntry("name", (String) "john"));
        assertThat(((Map<String, Object>) map.get("key")), hasEntry("id", (Integer) 123));
    }
