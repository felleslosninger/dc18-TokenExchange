...
import com.dc18TokenExchange.STSserver.jwt.exceptions.AlgorithmMismatchException;
import com.dc18TokenExchange.STSserver.jwt.exceptions.InvalidClaimException;
import com.dc18TokenExchange.STSserver.jwt.exceptions.TokenExpiredException;
...
public class JWTVerifierTest {
    ...
    // Issued At
    @Test
    public void shouldValidateIssuedAtWithLeeway() {
        Clock clock = mock(Clock.class);
        when(clock.getToday()).thenReturn(new Date(DATE_TOKEN_MS_VALUE - 1000));
